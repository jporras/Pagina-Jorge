...
<html lang="en">
  ...
  <head>
    ...
    <link rel="stylesheet" href="./css/bragas.css">
  ...
  <header id="inicio">
    ...
    <section id="bragas">
        <h3 class="coleccion-de-bragas">COLECCIÓN DE BRAGAS</h3>
        <div class="div-bragas">
          <div class="contenido-bragas">
            <label class="contenido-1" for="1">
            </label>
            <p class="informacion-bragas-1">10120-33290</p>
            <p class="informacion-bragas-2">MOST WANTED<br>Talla 3 - 13</p>
          </div>
          <div class="contenido-bragas">
            <label class="contenido-2" for="1">
            </label>
            <p class="informacion-bragas-1">10120-36587-BLK</p>
            <p class="informacion-bragas-2">MOST WANTED<br>Talla 3 - 13</p>
          </div>
          <div class="contenido-bragas">
            <label class="contenido-3" for="1">
            </label>
            <p class="informacion-bragas-1">P-066</p>
            <p class="informacion-bragas-2">SEXY CONTURE<br>Talla 3 - 13</p>
          </div>
          <div class="contenido-bragas">
            <label class="contenido-4" for="1">
            </label>
            <p class="informacion-bragas-1">P-063</p>
            <p class="informacion-bragas-2">SEXY CONTURE<br>Talla 3 - 13</p>
          </div>
        </div>
      </section>
      ...
      <section id="bragas">
        <div class="div-bragas">
          <div class="contenido-bragas">
            <label class="contenido-5" for="1">
            </label>
            <p class="informacion-bragas-1">P-059</p>
            <p class="informacion-bragas-2">SEXY CONTURE<br>Talla 3 - 13</p>
          </div>
          <div class="contenido-bragas">
            <label class="contenido-6" for="1">
            </label>
            <p class="informacion-bragas-1">AA-80932</p>
            <p class="informacion-bragas-2">SEXY CONTURE<br>Talla 3 - 13</p>
          </div>
        </div>
      </section>
