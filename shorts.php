...
<html lang="en">
  ...
  <header id="inicio">
    ...
    <section id="shorts">
        <h3 class="coleccion-de-shorts">COLECCIÓN DE SHORTS</h3>
        <div class="div-shorts">
          <div class="contenido-shorts">
            <label class="contenido-1" for="1">
            </label>
            <p class="informacion-shorts-1">33466</p>
            <p class="informacion-shorts-2">MONDAY<br>Talla 3 - 13</p>
          </div>
        </div>
      </section>
